...
UniformParticleGenerator::UniformParticleGenerator(string name, Vector3 pos, Vector3 vel, float maxDim,Vector3 shape, particleInfo model, int nP, bool oneT) : ParticleGenerator(name, pos, vel, model,maxDim, nP, oneT), shape(shape)
{
}
